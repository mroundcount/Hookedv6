...
class UserProfileViewController: UIViewController {
    ...
    //I don't actually use the 'presented' variable... let look into this more
    //var presented = false
    ...
    @IBAction func uploadBtnDidPress(_ sender: UIButton) {
        Api.User.getUserInforSingleEvent(uid: Api.User.currentUserId) { (user) in
            if user.profileImageUrl != "" {
                ...
                let alert = UIAlertController(title: "Whoa there cowboy!", message: "Make sure you have a profile pic before you upload music", preferredStyle: .alert)
    ...
    func observeAudioData() {
        ...
        //This is the old way the pulls from the old audio
        /*
