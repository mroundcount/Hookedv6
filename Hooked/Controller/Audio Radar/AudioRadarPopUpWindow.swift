//
//  AudioRadarPopUpWindow.swift
//  Hooked
//
//  Created by Michael Roundcount on 2/14/21.
...
protocol AudioRadarPopUpDelegate {
    func handleDismissal()
    func navigateToUpload()
    func navigateToWebsite()
}

class AudioRadarPopUpWindow: UIView {
    
    // MARK: - Properties
    var delegate: AudioRadarPopUpDelegate?
